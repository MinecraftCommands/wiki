...
Below is an example of storing a player's inventory in storage using the [scoreboard ID system](/questions/linkentity.md). To do this need to run function `example:storing` as a player.
